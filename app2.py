...
def play_alarm_sound():
    """Play an alarm beep sound using HTML5 audio"""
    alarm_html = """
    <audio autoplay>
        <source src="data:audio/wav;base64,UklGRnoGAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQoGAACBhYqFbF1fdJivrJBhNjVgodDbq2EcBj+a2/LDciUFLIHO8tiJNwgZaLvt559NEAxQp+PwtmMcBjiR1/LMeSwFJHfH8N2QQAoUXrTp66hVFApGn+DyvmwhBSuBzvLZiTYIGWm98OScTgwOU6zn77ZfHA" type="audio/wav">
    </audio>
    """
    components.html(alarm_html, height=0)

def play_continuous_alarm():
    """Play alarm sound that repeats for 2 seconds"""
    alarm_html = """
    <audio autoplay loop id="alarmSound">
        <source src="data:audio/wav;base64,UklGRnoGAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQoGAACBhYqFbF1fdJivrJBhNjVgodDbq2EcBj+a2/LDciUFLIHO8tiJNwgZaLvt559NEAxQp+PwtmMcBjiR1/LMeSwFJHfH8N2QQAoUXrTp66hVFApGn+DyvmwhBSuBzvLZiTYIGWm98OScTgwOU6zn77ZfHA" type="audio/wav">
    </audio>
    <script>
        setTimeout(function() {
...
def show_home_page():
    ...
    .hero-video {
        ...
        border-radius: 16px;
        overflow: hidden;
        box-shadow: 0 10px 40px rgba(122, 92, 255, 0.4),
    ...
    # Hero Section with video on left and text on right
    st.markdown("""
    <div class='hero-container'>
        <div class='hero-content'>
            <div class='hero-video'>
                <video autoplay muted loop playsinline preload="auto">
                    <source src="https://raw.githubusercontent.com/ShrieVarshini2004/KumoCount/master/crowd_video.mp4" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
            </div>
            <div class='hero-text'>
                <h1 class='neon-title'>KumoCount</h1>
    ...
    st.markdown("<h2 style='text-align: center; color: #FFFFFF; font-size: 2.5rem; margin-bottom: 60px; text-shadow: 0 2px 10px rgba(0, 0, 0, 0.8), 0 0 30px rgba(122, 92, 255, 0.6); font-weight: 800;'>Choose Your Detection Mode</h2>", unsafe_allow_html=True)
    ...
    with col_a:
        ...
        st.markdown("""
        <style>
        div[data-testid="column"]:nth-of-type(1) button[kind="primary"] p {
            color: #FFFFFF !important;
    ...
    with col_b:
        ...
        st.markdown("""
        <style>
        div[data-testid="column"]:nth-of-type(2) button[kind="primary"] p {
            color: #FFFFFF !important;
            font-weight: 700 !important;
        }
        </style>
    ...
    <div style='max-width: 1200px; margin: 0 auto;'>
        <h3 style='text-align: center; color: #FFFFFF; font-size: 2.2rem; margin-bottom: 50px; text-shadow: 0 2px 10px rgba(0, 0, 0, 0.8), 0 0 30px rgba(0, 212, 255, 0.6); font-weight: 800;'>
            ✨ Features
        </h3>
    </div>
    """, unsafe_allow_html=True)
    ...
    with feat_col1:
        ...
        <div class='feature-item'>
            ...
            <div>
                <strong style='color: #FFFFFF; font-size: 1.1rem;'>Accurate Detection</strong>
                <p style='color: #E0E0E0; margin: 5px 0 0 0;'>YOLO-powered person detection with high precision</p>
            </div>
        </div>
        <div class='feature-item'>
            <span style='font-size: 2rem; margin-right: 15px;'>🚨</span>
            <div>
                <strong style='color: #FFFFFF; font-size: 1.1rem;'>Smart Alerts</strong>
                <p style='color: #E0E0E0; margin: 5px 0 0 0;'>Configurable thresholds and intelligent alarm system</p>
            </div>
        </div>
        <div class='feature-item'>
            <span style='font-size: 2rem; margin-right: 15px;'>📊</span>
            <div>
                <strong style='color: #FFFFFF; font-size: 1.1rem;'>Real-time Analytics</strong>
                <p style='color: #E0E0E0; margin: 5px 0 0 0;'>Live count tracking with visual feedback</p>
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with feat_col2:
        ...
        <div class='feature-item'>
            <span style='font-size: 2rem; margin-right: 15px;'>🎨</span>
            <div>
                <strong style='color: #FFFFFF; font-size: 1.1rem;'>Visual Feedback</strong>
                <p style='color: #E0E0E0; margin: 5px 0 0 0;'>Bounding boxes with confidence scores overlay</p>
            </div>
        </div>
        <div class='feature-item'>
            <span style='font-size: 2rem; margin-right: 15px;'>📈</span>
            <div>
                <strong style='color: #FFFFFF; font-size: 1.1rem;'>Detailed Statistics</strong>
                <p style='color: #E0E0E0; margin: 5px 0 0 0;'>Comprehensive counting history and trends</p>
            </div>
        </div>
        <div class='feature-item'>
            <span style='font-size: 2rem; margin-right: 15px;'>💾</span>
            <div>
                <strong style='color: #FFFFFF; font-size: 1.1rem;'>Export Capability</strong>
                <p style='color: #E0E0E0; margin: 5px 0 0 0;'>Download alarm logs and analysis reports</p>
            </div>
        </div>
        """, unsafe_allow_html=True)
...
def show_image_page():
    ...
    st.title("📷 Image Crowd Detection")
    ...
    enable_sound = st.sidebar.checkbox("Enable Beep Sound", True)
        ...
        if st.button("Start Detection", type="primary", use_container_width=True):
            with st.spinner("🔄 Analyzing image..."):
                ...
                with col2:
                    ...
                    st.metric("CSRNet Count", csrnet_count)
    ...
    if uploaded_file is not None:
        ...
        if st.button("Start Processing", type="primary", use_container_width=True):
            process_video(video_path, confidence_threshold, fusion_method, enable_alarm, 
                         alarm_threshold, warning_threshold, process_every_n_frames, max_frames, enable_sound)
                ...
                if frame_count % 2 == 0:
                    ...
                    if enable_alarm:
                        if final_count >= alarm_threshold:
                            ...
                            # FIXED: Use continuous alarm with cooldown
                            if enable_sound:
                                current_time = time.time()
                                if current_time - st.session_state.last_alarm_time > 2.5:
                                    play_continuous_alarm()
                    ...
                    with stats_placeholder.container():
                        ...
                        stat_col1.metric("Duration", f"{elapsed_time:.0f}s")
...
def process_video(video_path, confidence_threshold, fusion_method, 
                 ...
                 process_every_n_frames, max_frames, enable_sound):
    ...
    # ADD: Cooldown timer to prevent sound spam
    last_alarm_time = 0
    ...
    while frame_count < frames_to_process:
        ...
        if enable_alarm:
            if final_count >= alarm_threshold:
                ...
                if enable_sound:
                    current_time = time.time()
                    if current_time - last_alarm_time > 2.5:
                        play_continuous_alarm()
