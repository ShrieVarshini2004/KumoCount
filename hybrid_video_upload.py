...
def main():
    ...
    # Configuration
    CSRNET_MODEL = None  # Set to 'csrnet_partA_best.pth' if you have CSRNet model, None for YOLO only
    
    # VIDEO/CAMERA SOURCE
    # Option 1: Use webcam -> CAMERA_ID = 0
    # Option 2: Use video file -> CAMERA_ID = 'your_video.mp4'
    # Option 3: Use URL stream -> CAMERA_ID = 'http://your-stream-url'
    CAMERA_ID = 'crowd_video.mp4'  # Your video file
    ...
    ALARM_THRESHOLD = 10  # Maximum number of people before alarm triggers (adjust for your video!)
